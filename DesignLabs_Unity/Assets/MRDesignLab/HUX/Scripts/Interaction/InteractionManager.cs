...
namespace HUX.Interaction
{
    public class InteractionManager : Singleton<InteractionManager>
    {
        ...
        public static Action<UnityEngine.XR.WSA.Input.InteractionSourceState> SourceLost { get; internal set; }
		...
		protected void Start()
        {
			...
			UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourcePressedLegacy += InteractionManager_SourcePressedCallback;
			UnityEngine.XR.WSA.Input.InteractionManager.InteractionSourceReleasedLegacy += InteractionManager_SourceReleasedCallback;
