...

{
    ...
    private void Awake()
    {
        ...
        InteractionManager.InteractionSourceDetectedLegacy += WSASourceEntered;

        InteractionManager.InteractionSourceLostLegacy += WSASourceLost;

        InteractionManager.InteractionSourceUpdatedLegacy += WSASourceUpdate;



        InteractionManager.InteractionSourcePressedLegacy += WSAFingerPressed;

        InteractionManager.InteractionSourceReleasedLegacy += WSAFingerReleased;
